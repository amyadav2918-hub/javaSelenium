...
public class WebUtil {
    ...
    public void launchBrowser(String browserName) {
    	if(browserName.equalsIgnoreCase("edge")) {
    		...
    		extentTest.log(Status.INFO, "Chrome Browser has been pass");
    ...
    public void click(WebElement element) {
        System.out.println("Attempting to click element with XPath: " );
        
        try {
           // WebElement element = getElement(xpath);
            element.click();
            System.out.println("Element clicked successfully with XPath: " );
    ...
    public void sendKeys(WebElement element , String text) {
        System.out.println("Attempting to send text '" + text + "' to element with XPath: " );
        
        try {
           // WebElement element = getElement(xpath);
            element.clear();
            element.sendKeys(text);
            System.out.println("Text '" + text + "' sent successfully to element with XPath: " );
        } catch (ElementNotInteractableException e) {
    ...
    public void jsClick( WebElement element) {
        try {
           ...
           // WebElement element = getElement(xpath);
            ...
            System.out.println("JavaScript click performed successfully on element with XPath: " );
        } catch (StaleElementReferenceException e) {
            ...
            throw new RuntimeException("JavaScript click failed for XPath: " , e);
        }
    }
    ...
    public void jsSendKeys(WebElement element , String text) {
        try {
          ...
          //  WebElement element = getElement(xpath);
            ...
            System.out.println("JavaScript sendKeys performed successfully on element with XPath: " );
        } catch (StaleElementReferenceException e) {
            ...
            throw new RuntimeException("JavaScript sendKeys failed for XPath: " , e);
        }
    }
    ...
    public String getAttribute(String xpath, String attributeName) {
        try {
            ...
            System.out.println("Retrieved attribute '" + attributeName + "': '" + value + "' from element with XPath: " + xpath);
            return value;
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in getAttribute, retrying...");
            waitForMillis(1000);
            return getAttribute(xpath, attributeName); // Recursive retry
        } catch (Exception e) {
            System.out.println("ERROR: Failed to get attribute: " + e.getMessage());
            throw new RuntimeException("Failed to get attribute for XPath: " + xpath, e);
        }
    }
    ...
    public boolean isDisplayed(String xpath) {
        try {
            ...
            System.out.println("Element with XPath " + xpath + " is displayed: " + displayed);
            return displayed;
        } catch (NoSuchElementException e) {
            System.out.println("Element not found when checking display status: " + xpath);
            return false;
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in isDisplayed, retrying...");
            waitForMillis(1000);
            return isDisplayed(xpath); // Recursive retry
        } catch (Exception e) {
    ...
    public boolean isEnabled(String xpath) {
        try {
            ...
            System.out.println("Element with XPath " + xpath + " is enabled: " + enabled);
            return enabled;
        } catch (NoSuchElementException e) {
            System.out.println("Element not found when checking enabled status: " + xpath);
            return false;
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in isEnabled, retrying...");
            waitForMillis(1000);
            return isEnabled(xpath); // Recursive retry
        } catch (Exception e) {
    ...
    public boolean isSelected(String xpath) {
        try {
            ...
            System.out.println("Element with XPath " + xpath + " is selected: " + selected);
            return selected;
        } catch (NoSuchElementException e) {
            System.out.println("Element not found when checking selected status: " + xpath);
            return false;
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in isSelected, retrying...");
            waitForMillis(1000);
            return isSelected(xpath); // Recursive retry
        } catch (Exception e) {
    ...
    public void jsScrollToElement(String xpath) {
        try {
            ...
            waitForMillis(1000);
            jsScrollToElement(xpath); // Recursive retry
        } catch (Exception e) {
            System.out.println("ERROR: JavaScript scroll failed: " + e.getMessage());
            throw new RuntimeException("JavaScript scroll failed for XPath: " + xpath, e);
        }
    }
     ...
     * @param xpath XPath string to locate the element
     */
    public void actionsClick(String xpath) {
        try {
        	Actions actions=new Actions(driver);
            WebElement element = getElement(xpath);
            actions.click(element).perform();
            System.out.println("Actions click performed on element with XPath: " + xpath);
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in actionsClick, retrying...");
            waitForMillis(1000);
            actionsClick(xpath); // Recursive retry
        } catch (Exception e) {
            System.out.println("ERROR: Actions click failed: " + e.getMessage());
            throw new RuntimeException("Actions click failed for XPath: " + xpath, e);
        }
    }
    ...
    public void actionsDoubleClick(String xpath) {
        try {
            ...
            System.out.println("Actions double click performed on element with XPath: " + xpath);
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in actionsDoubleClick, retrying...");
            waitForMillis(1000);
            actionsDoubleClick(xpath); // Recursive retry
        } catch (Exception e) {
            System.out.println("ERROR: Actions double click failed: " + e.getMessage());
            throw new RuntimeException("Actions double click failed for XPath: " + xpath, e);
        }
    }
     ...
     * @param xpath XPath string to locate the element
     */
    public void actionsContextClick(String xpath) {
        try {
        	Actions actions=new Actions(driver);

            WebElement element = getElement(xpath);
            actions.contextClick(element).perform();
            System.out.println("Actions context click performed on element with XPath: " + xpath);
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in actionsContextClick, retrying...");
            waitForMillis(1000);
            actionsContextClick(xpath); // Recursive retry
        } catch (Exception e) {
            System.out.println("ERROR: Actions context click failed: " + e.getMessage());
            throw new RuntimeException("Actions context click failed for XPath: " + xpath, e);
        }
    }
     ...
     */
    public void actionsDragAndDrop(String sourceXpath, String targetXpath) {
        try {
        	Actions actions=new Actions(driver);
     ...
     */
    public void actionsSendKeys(String xpath, String text) {
        try {
        	Actions actions=new Actions(driver);

            WebElement element = getElement(xpath);
            actions.sendKeys(element, text).perform();
            System.out.println("Actions sendKeys performed on element with XPath: " + xpath);
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in actionsSendKeys, retrying...");
            waitForMillis(1000);
            actionsSendKeys(xpath, text); // Recursive retry
        } catch (Exception e) {
            System.out.println("ERROR: Actions sendKeys failed: " + e.getMessage());
            throw new RuntimeException("Actions sendKeys failed for XPath: " + xpath, e);
        }
    }
    ...
    public void selectByVisibleText(String xpath, String text) {
        try {
            ...
            System.out.println("Selected option by visible text '" + text + "' from dropdown with XPath: " + xpath);
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in selectByVisibleText, retrying...");
            waitForMillis(1000);
            selectByVisibleText(xpath, text); // Recursive retry
        } catch (NoSuchElementException e) {
            System.out.println("Option with text '" + text + "' not found in dropdown");
            throw new RuntimeException("Option with text '" + text + "' not found in dropdown: " + xpath, e);
        } catch (Exception e) {
            System.out.println("ERROR: Failed to select by visible text: " + e.getMessage());
            throw new RuntimeException("Failed to select by visible text: " + xpath, e);
        }
    }
    ...
    public void selectByValue(String xpath, String value) {
        try {
            ...
            System.out.println("Selected option by value '" + value + "' from dropdown with XPath: " + xpath);
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in selectByValue, retrying...");
            waitForMillis(1000);
            selectByValue(xpath, value); // Recursive retry
        } catch (NoSuchElementException e) {
            System.out.println("Option with value '" + value + "' not found in dropdown");
            throw new RuntimeException("Option with value '" + value + "' not found in dropdown: " + xpath, e);
        } catch (Exception e) {
            System.out.println("ERROR: Failed to select by value: " + e.getMessage());
            throw new RuntimeException("Failed to select by value: " + xpath, e);
        }
    }
    ...
    public void selectByIndex(String xpath, int index) {
        try {
            ...
            System.out.println("Selected option by index " + index + " from dropdown with XPath: " + xpath);
        } catch (StaleElementReferenceException e) {
            System.out.println("Stale element in selectByIndex, retrying...");
            waitForMillis(1000);
            selectByIndex(xpath, index); // Recursive retry
        } catch (NoSuchElementException e) {
            System.out.println("Option with index " + index + " not found in dropdown");
            throw new RuntimeException("Option with index " + index + " not found in dropdown: " + xpath, e);
        } catch (Exception e) {
            System.out.println("ERROR: Failed to select by index: " + e.getMessage());
            throw new RuntimeException("Failed to select by index: " + xpath, e);
        }
    }
    ...
    public void switchToFrame(String xpath) {
        try {
            ...
            System.out.println("Switched to frame with XPath: " + xpath);
        } catch (NoSuchFrameException e) {
            System.out.println("Frame not found with XPath: " + xpath);
            throw new RuntimeException("Frame not found: " + xpath, e);
        } catch (Exception e) {
            System.out.println("ERROR: Failed to switch to frame: " + e.getMessage());
            throw new RuntimeException("Failed to switch to frame: " + xpath, e);
        }
    }
     ...
     */
    public void validateTextEquals(String xpath, String expectedText, String message) {
     ...
     * @throws AssertionError if validation fails
     */
    public void validateTextContains(String xpath, String expectedText, String message) {
        String actualText = getText(xpath);
     ...
     * @throws AssertionError if validation fails
     */
    public void validateAttributeEquals(String xpath, String attributeName, String expectedValue, String message) {
        String actualValue = getAttribute(xpath, attributeName);
     ...
     * @throws AssertionError if validation fails
     */
    public void validateElementPresent(String xpath, String message) {
        try {
            getElement(xpath);
            System.out.println("VALIDATION PASSED: " + message);
        } catch (Exception e) {
            String errorMsg = message + " - Element not found with XPath: " + xpath;
            System.out.println("VALIDATION FAILED: " + errorMsg);
            throw new AssertionError(errorMsg);
        }
    }
     ...
     * @throws AssertionError if validation fails
     */
    public void validateElementNotPresent(String xpath, String message) {
        try {
            getElement(xpath);
            String errorMsg = message + " - Element should not be present but was found with XPath: " + xpath;
            System.out.println("VALIDATION FAILED: " + errorMsg);
            throw new AssertionError(errorMsg);
        } catch (Exception e) {
            System.out.println("VALIDATION PASSED: " + message);
     ...
     * @throws AssertionError if validation fails
     */
    public void validateElementVisible(String xpath, String message) {
        if (!isDisplayed(xpath)) {
            String errorMsg = message + " - Element not visible with XPath: " + xpath;
            System.out.println("VALIDATION FAILED: " + errorMsg);
            throw new AssertionError(errorMsg);
        }
        System.out.println("VALIDATION PASSED: " + message);
     ...
     * @throws AssertionError if validation fails
     */
    public void validateElementNotVisible(String xpath, String message) {
        if (isDisplayed(xpath)) {
            String errorMsg = message + " - Element should not be visible but was found with XPath: " + xpath;
            System.out.println("VALIDATION FAILED: " + errorMsg);
            throw new AssertionError(errorMsg);
        }
        System.out.println("VALIDATION PASSED: " + message);
     ...
     * @throws AssertionError if validation fails
     */
    public void validateElementEnabled(String xpath, String message) {
        if (!isEnabled(xpath)) {
            String errorMsg = message + " - Element not enabled with XPath: " + xpath;
            System.out.println("VALIDATION FAILED: " + errorMsg);
            throw new AssertionError(errorMsg);
        }
        System.out.println("VALIDATION PASSED: " + message);
     ...
     * @throws AssertionError if validation fails
     */
    public void validateElementDisabled(String xpath, String message) {
        if (isEnabled(xpath)) {
            String errorMsg = message + " - Element should be disabled but was enabled with XPath: " + xpath;
            System.out.println("VALIDATION FAILED: " + errorMsg);
            throw new AssertionError(errorMsg);
        }
        System.out.println("VALIDATION PASSED: " + message);
    ...
    public void uploadFile(String xpath, String filePath) {
        try {
            ...
            throw new RuntimeException("Failed to upload file to element: " + xpath, e);
        }
    }
    ...
    public void selectFromDropdownByText(String xpath, String text) {
        try {
            ...
            System.out.println("Selected option by text '" + text + "' from dropdown with XPath: " + xpath);
        } catch (Exception e) {
            System.out.println("ERROR: Failed to select by visible text: " + e.getMessage());
            throw new RuntimeException("Failed to select by visible text: " + xpath, e);
        }
    ...
    public void selectFromDropdownByValue(  WebElement element,String value) {
        try {
            ...
            System.out.println("Selected option by value '" + value + "' from dropdown ");
        } catch (Exception e) {
            System.out.println("ERROR: Failed to select by value: " + e.getMessage());
            throw new RuntimeException("Failed to select by value: "  +e);
        }
    }
     ...
     */
    public String getSelectedDropdownOption(String xpath) {
        try {
            WebElement element = getElement(xpath);
            Select dropdown = new Select(element);
            String selectedText = dropdown.getFirstSelectedOption().getText();
            System.out.println("Selected option text: '" + selectedText + "' from dropdown with XPath: " + xpath);
            return selectedText;
        } catch (Exception e) {
            System.out.println("ERROR: Failed to get selected dropdown option: " + e.getMessage());
            throw new RuntimeException("Failed to get selected dropdown option: " + xpath, e);
        }
    }
    ...
    public List<String> getAllDropdownOptions(String xpath) {
        try {
            ...
            System.out.println("Found " + optionTexts.size() + " options in dropdown with XPath: " + xpath);
            return optionTexts;
        } catch (Exception e) {
            System.out.println("ERROR: Failed to get dropdown options: " + e.getMessage());
            throw new RuntimeException("Failed to get dropdown options: " + xpath, e);
        }
    }
     ...
     */
    public boolean isDropdownOptionPresent(String xpath, String optionText) {
        try {
            List<String> options = getAllDropdownOptions(xpath);
    ...
    public void mouseOver(String xpath) {
        try {
            ...
            System.out.println("Hovered over element with XPath: " + xpath);
        } catch (Exception e) {
            System.out.println("ERROR: Failed to hover over element: " + e.getMessage());
            throw new RuntimeException("Failed to hover over element: " + xpath, e);
        }
    }
...
//	 File fileTosaveFile =new File("test-output");  
//	 FileUtils.copy(file,fileToSave); 
//	   
//	   
//	   
//   }
